...
[_QWERTY] = LAYOUT_ortho_4x12(
  ...
  MO(_ADJUST),        KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LPRN, KC_RPRN, KC_LBRC,   KC_RBRC \
),
...
[_FUNCTION] = LAYOUT_ortho_4x12(
  ...
  KC_CAPS, LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), _______, _______, _______, _______, _______, _______, _______, \
